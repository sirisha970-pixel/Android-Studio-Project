...
public class LisActivity1 extends AppCompatActivity {

    Button playButton, speakButton, backButton, nextButton;
    TextView resultText;
    TextToSpeech tts;
    private static final int SPEECH_REQUEST_CODE = 100;
    private final String sentenceToSpeak = "This is my pen";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_lis1);
        ...
        nextButton.setOnClickListener(v -> {
            Intent intent = new Intent(this, LisActivity2.class);
