...
public class ReadActivity4 extends AppCompatActivity {
    ...
    String targetSentence = "Practice makes a man perfect.";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        speakerIcon.setOnClickListener(v -> {
            try {
                MediaPlayer mp = MediaPlayer.create(ReadActivity4.this, R.raw.sample_audio); // optional audio file in res/raw
                mp.start();
            } catch (Exception e) {
                Toast.makeText(ReadActivity4.this, "Audio not found!", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        replayButton.setOnClickListener(v ->
                Toast.makeText(ReadActivity4.this, "Voice playback feature coming soon!", Toast.LENGTH_SHORT).show()
        );
// ✅ Navigation Buttons (Optional)
        nextButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(ReadActivity4.this, "Open Dashboard ", Toast.LENGTH_SHORT).show();

                Intent intent = new Intent(ReadActivity4.this, DashboardActivity.class);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(ReadActivity4.this, "module 3 ", Toast.LENGTH_SHORT).show();

                Intent intent = new Intent(ReadActivity4.this, ReadActivity3.class);
                startActivity(intent);
    ...
    private void startSpeechRecognition() {
        ...
        speechRecognizer.setRecognitionListener(new RecognitionListener() {
            ...
            public void onError(int error) {
                Toast.makeText(ReadActivity4.this, "Please try speaking again.", Toast.LENGTH_SHORT).show();
            }
