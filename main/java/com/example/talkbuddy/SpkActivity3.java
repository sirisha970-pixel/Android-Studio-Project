...
public class SpkActivity3 extends AppCompatActivity {

    private static final int REQ_CODE_SPEECH_INPUT = 100;
    Button speakBtn, checkBtn,nextBtn,backBtn;
    TextView wordLabel, resultText;
    String spokenText = "";
    String targetWord = "A college is an institution of higher education that provides post-secondary education, typically granting associate or bachelor's degrees. It can also refer to a specialized training school or a constituent part of a larger university.";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_spk3);
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(SpkActivity3.this, "Opening Module4 ", Toast.LENGTH_SHORT).show();

                Intent intent = new Intent(SpkActivity3.this, SpkActivity4.class);
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(SpkActivity3.this, "Module2 ", Toast.LENGTH_SHORT).show();

                Intent intent = new Intent(SpkActivity3.this, SpkActivity2.class);
                startActivity(intent);
