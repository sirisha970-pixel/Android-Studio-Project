...
public class ReadActivity2 extends AppCompatActivity {
    ...
    String targetSentence = "Peter Piper picked a peck of pickled peppers.";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        speakerIcon.setOnClickListener(v -> {
            try {
                MediaPlayer mp = MediaPlayer.create(ReadActivity2.this, R.raw.sample_audio); // optional audio file in res/raw
                mp.start();
            } catch (Exception e) {
                Toast.makeText(ReadActivity2.this, "Audio not found!", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        replayButton.setOnClickListener(v ->
                Toast.makeText(ReadActivity2.this, "Voice playback feature coming soon!", Toast.LENGTH_SHORT).show()
        );
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(ReadActivity2.this, "Opening Module3 ", Toast.LENGTH_SHORT).show();

                Intent intent = new Intent(ReadActivity2.this, ReadActivity3.class);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(ReadActivity2.this, "Module1 ", Toast.LENGTH_SHORT).show();

                Intent intent = new Intent(ReadActivity2.this, ReadActivity1.class);
                startActivity(intent);
    ...
    private void startSpeechRecognition() {
        ...
        speechRecognizer.setRecognitionListener(new RecognitionListener() {
            ...
            public void onError(int error) {
                Toast.makeText(ReadActivity2.this, "Please try speaking again.", Toast.LENGTH_SHORT).show();
            }
