...
public class LisActivity2 extends AppCompatActivity {

    Button playButton, speakButton, backButton, nextButton;
    TextView resultText;
    TextToSpeech tts;
    private static final int SPEECH_REQUEST_CODE = 100;
    private final String sentenceToSpeak = "This is my chair";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_lis2);
        ...
        nextButton.setOnClickListener(v -> {
            Intent intent = new Intent(this, LisActivity3.class);
