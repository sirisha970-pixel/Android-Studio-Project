...
public class ReadActivity1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        speakerIcon.setOnClickListener(v -> {
            try {
                MediaPlayer mp = MediaPlayer.create(ReadActivity1.this, R.raw.sample_audio); // optional audio file in res/raw
                mp.start();
            } catch (Exception e) {
                Toast.makeText(ReadActivity1.this, "Audio not found!", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        replayButton.setOnClickListener(v ->
                Toast.makeText(ReadActivity1.this, "Voice playback feature coming soon!", Toast.LENGTH_SHORT).show()
        );
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(ReadActivity1.this, "Opening Module2 ", Toast.LENGTH_SHORT).show();

                Intent intent = new Intent(ReadActivity1.this, ReadActivity2.class);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(ReadActivity1.this, "main Module ", Toast.LENGTH_SHORT).show();

                Intent intent = new Intent(ReadActivity1.this, MainActivity4.class);
                startActivity(intent);
    ...
    private void startSpeechRecognition() {
        ...
        speechRecognizer.setRecognitionListener(new RecognitionListener() {
            ...
            public void onError(int error) {
                Toast.makeText(ReadActivity1.this, "Please try speaking again.", Toast.LENGTH_SHORT).show();
            }
