    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        module1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(MainActivity6.this, "Opening Module1 ", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(MainActivity6.this, ReadActivity1.class);
        ...
        module2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(MainActivity6.this, "Opening Module2 ", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(MainActivity6.this, ReadActivity2.class);
                startActivity(intent);
        ...
        module3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(MainActivity6.this, "Opening Module3 ", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(MainActivity6.this, ReadActivity3.class);
                startActivity(intent);
        ...
        module4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(MainActivity6.this, "Opening Module4 ", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(MainActivity6.this, ReadActivity4.class);
                startActivity(intent);
        ...
        nextButton.setOnClickListener(view -> {
            ...
            Toast.makeText(MainActivity6.this, "Next button clicked", Toast.LENGTH_SHORT).show();
        });
    }
